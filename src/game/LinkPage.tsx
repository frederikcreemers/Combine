  ...
  if (error) {
    return (
      <div class="min-h-screen bg-gray-100 dark:bg-gray-950 flex items-center justify-center">
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6 max-w-md w-full mx-4 text-center">
          <h1 class="text-xl font-semibold text-red-600 mb-4">Error</h1>
          <p class="text-gray-600 dark:text-gray-300 mb-4">{error}</p>
          <a href="/" class="text-blue-600 dark:text-blue-400 hover:underline">Go to home page</a>
        </div>
      </div>
    )
  }
  ...
  return (
    <div class="min-h-screen bg-gray-100 dark:bg-gray-950 flex items-center justify-center">
      <div class="bg-white dark:bg-gray-900 rounded-lg shadow-xl p-6 max-w-md w-full mx-4 text-center">
        ...
        <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">Linking Account...</h1>
      </div>
    </div>
  )
}
